...
#ifndef _I_SOCKET_HANDLER_H_INCLUDE
#define _I_SOCKET_HANDLER_H_INCLUDE
...
public:
     ...
     */
    virtual void LogError( Socket *p,
                           const std::string& user_text,
                           int err,
                           const std::string& sys_err,
                           loglevel_t t = LOG_LEVEL_WARNING) = 0;
...
#endif//_I_SOCKET_HANDLER_H_INCLUDE
