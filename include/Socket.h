...
public:
     ...
     * "Default" constructor
     */
    explicit Socket(ISocketHandler&);
...
private:
    ...
    std::unique_ptr<SocketAddress> m_client_remote_address; ///< Address of last connect()
    std::unique_ptr<SocketAddress> m_remote_address;        ///< Remote end address
