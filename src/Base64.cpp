...
void Base64::encode(IFile *file, std::string& output, bool add_crlf)
{
    size_t remain;
    size_t i = 0;
    size_t o = 0;
...
void Base64::encode(FILE *file, std::string& output, bool add_crlf)
{
    size_t remain;
    size_t i = 0;
    size_t o = 0;
